...
function getJsonFromModelResponse(providerData) {
...
export async function POST(request) {
  try {
    ...
    const user = await User.findById(userId)
      .select("businessIdea businessCategory budget experience state district")
      .lean();
    ...
    if (!providerResponse.ok) {
      console.error("Gemini recommendation error:", await providerResponse.text());
      return NextResponse.json(
    ...
    const responseData = getJsonFromModelResponse(await providerResponse.json());
