      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        {invoice && <section className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <label className="text-sm font-semibold text-slate-700">Invoice Type<select value={invoice.invoiceType || "unknown"} onChange={handleInvoiceTypeChange} className="mt-2 w-full rounded-xl border px-3 py-2.5 font-normal outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100"><option value="unknown">Select type</option><option value="sale">SALE</option><option value="purchase">PURCHASE</option></select></label>
